...
public class AddopTermListMany extends AddopTermList {

    private Addop Addop;
    private Term Term;
    private AddopTermList AddopTermList;

    public AddopTermListMany (Addop Addop, Term Term, AddopTermList AddopTermList) {
        this.Addop=Addop;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("AddopTermListMany(\n");
